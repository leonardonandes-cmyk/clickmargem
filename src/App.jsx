...
function Login({ onEnter }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 380, background: "var(--card)", border: "1px solid var(--line)", borderRadius: 20, padding: "34px 26px", textAlign: "center" }}>
        <div style={{ width: 52, height: 52, borderRadius: 15, background: "var(--pur)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}><TrendingUp size={28} color="#fff" /></div>
        <div style={{ fontSize: 22, fontWeight: 700, marginBottom: 4 }}>Click<span style={{ color: "var(--pur)" }}>margem</span></div>
        <div style={{ fontSize: 13.5, color: "var(--tx2)", marginBottom: 24 }}>Digite seu nome para come\u00e7ar</div>
