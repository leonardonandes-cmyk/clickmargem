...
const DEFAULT = {
  ...
  canais: [
    { id: 1, nome: "Kwai", cor: "#FF6A2C", logo: "/logos/kwai.png", com: "8", afi: "0", fix: "0,00", frete: "0,00" },
    { id: 2, nome: "TikTok Shop", cor: "#111318", logo: "/logos/tiktok.png", com: "6", afi: "3", fix: "1,20", frete: "0,00" },
    { id: 3, nome: "Temu", cor: "#FB7701", logo: "/logos/temu.png", com: "15", afi: "0", fix: "0,00", frete: "0,00" },
    { id: 4, nome: "Shein", cor: "#111318", logo: "/logos/shein.png", com: "16", afi: "0", fix: "0,00", frete: "0,00" },
    { id: 5, nome: "Shopee", cor: "#EE4D2D", logo: "/logos/shopee.png", com: "14", afi: "0", fix: "4,00", frete: "0,00" },
    { id: 6, nome: "Mercado Livre", cor: "#F5C518", logo: "/logos/mercadolivre.png", com: "14", afi: "0", fix: "6,00", frete: "0,00" },
  ],
  historico: [],
};
...
function ChannelCard({ c, setCanal }) {
  ...
  return (
    <div style={{ background: "var(--card)", border: "1px solid var(--line)", borderRadius: 16, padding: "16px 18px" }}>
      ...
      <button onClick={() => setLogoOpen((o) => !o)} style={{ marginTop: 13, background: "none", border: "none", padding: 0, cursor: "pointer", color: "var(--tx3)", fontSize: 11.5, fontWeight: 600, fontFamily: "inherit", display: "inline-flex", alignItems: "center", gap: 4 }}>
        <ChevronDown size={13} style={{ transform: logoOpen ? "rotate(180deg)" : "none", transition: "transform .2s" }} /> {logoOpen ? "Ocultar logo" : "Logo do canal"}
      </button>
      {logoOpen && (
        <div style={{ marginTop: 9 }}>
          <Field label="Endereço do logo (arquivo no seu GitHub)"><Input value={c.logo} onChange={(v) => setCanal(c.id, "logo", v)} /></Field>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 20, gap: 18 }}>
      ...
      <div style={{ width: "100%", maxWidth: 380, background: "var(--card)", border: "1px solid var(--line)", borderRadius: 20, padding: "26px 24px", textAlign: "center" }}>
        <div style={{ fontSize: 22, fontWeight: 700, marginBottom: 4 }}>Click<span style={{ color: "var(--pur)" }}>margem</span></div>
        <div style={{ fontSize: 13.5, color: "var(--tx2)", marginBottom: 20 }}>Digite seu nome para começar</div>
